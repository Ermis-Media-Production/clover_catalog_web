...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <aside
        className={`fixed top-0 right-0 h-full w-full max-w-sm bg-background border-l border-border z-50 flex flex-col shadow-2xl transition-transform duration-300 ease-out ${
